...
def load_photos():
    """
    Load all photos from train_data/photo
    """
    photos = []
    images_folder = os.path.join("train_data", "photo")
...
def load_illustrations():
    """
    Load all illustrations from train_data/other
    """
    illustrations = []
    images_folder = os.path.join("train_data", "other")
    for img_name in os.listdir(images_folder): 
        img_path = os.path.join(images_folder, img_name) # Path
        img = Image.open(img_path) # Image file
